...
src_pristine = r"D:\Usuarios\ccampos\.gemini\antigravity-cli\scratch\NnaCreatePage_pristine_3634.tsx"
workspace_dir = r"D:\Usuarios\ccampos\Documents\Python Scripts\Educadores_calle\educadores-calle-system\client"

if os.path.exists(src_pristine):
    shutil.copyfile(src_pristine, dest_file)
    print("Copied NnaCreatePage_pristine_3634.tsx to active path.")
    ...
    try:
        ...
        if res.returncode == 0:
            print("CONGRATULATIONS! Pristine baseline compiled and built successfully with 0 errors!")
        else:
            print("FAILED. Errors:")
