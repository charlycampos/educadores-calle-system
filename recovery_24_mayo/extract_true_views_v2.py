...
def is_target_content(content):
    # The header has: File Path: `file:///D:/Usuarios/ccampos/Documents/Python%20Scripts/Educadores_calle/educadores-calle-system/client/src/features/nna/NnaCreatePage.tsx`
    if not content:
        return False
                ...
                if data.get("type") == "VIEW_FILE" and "content" in data:
                    ...
                    if is_target_content(content_str):
                        ...
                        if lines_dict:
                            ...
                            print(f"  Line {idx+1} | True view of {name} from {min_l} to {max_l} | Size: {len(lines_dict)}")
